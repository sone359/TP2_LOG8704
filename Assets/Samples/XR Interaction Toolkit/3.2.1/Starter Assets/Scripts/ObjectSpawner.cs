...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class ObjectSpawner : MonoBehaviour
    {
        ...
        [SerializeField]
        [Tooltip("Height offset above the detected surface where the object will be spawned.")]
        float m_SpawnHeightOffset = 1.5f;

        /// <summary>
        /// Height offset above the detected surface where the object will be spawned.
        /// </summary>
        ...
        {
            if (global::InteractionFlag.isInteracting)
                return false;
            ...
            newObject.transform.position = spawnPoint + new Vector3(0f, m_SpawnHeightOffset, 0f);
            EnsureFacingCamera();
